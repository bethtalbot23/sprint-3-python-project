...
jp_sales_total = 0
for game in video_game_sales:
    na_sales_total = na_sales_total + game[NA_SALES]
    jp_sales_total = jp_sales_total + game[JP_SALES]
print(na_sales_total) 
print(jp_sales_total)
if na_sales_total > jp_sales_total:
    print('North America')
elif jp_sales_total > na_sales_total:
    print('Japan')
else:
    print('Tie')
